...
/* harmony import */ var _inputForNum__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./inputForNum */ "./src/js/modules/inputForNum.js");



var calcHandler = function calcHandler(state) {
  ...
  Object(_inputForNum__WEBPACK_IMPORTED_MODULE_1__["default"])(width);
  Object(_inputForNum__WEBPACK_IMPORTED_MODULE_1__["default"])(height);

  var calcHandlerBind = function calcHandlerBind(event, elem, prop) {
...
/* harmony default export */ __webpack_exports__["default"] = (calcHandler);
...
/* harmony import */ var _inputForNum__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./inputForNum */ "./src/js/modules/inputForNum.js");
...
var forms = function forms(state) {
  ...
  Object(_inputForNum__WEBPACK_IMPORTED_MODULE_5__["default"])(inputNumber);

  var formHandler = function formHandler(url, data) {
    var res;
    return regeneratorRuntime.async(function formHandler$(_context) {
      while (1) {
  ...
  allForms.forEach(function (form) {
    form.addEventListener("submit", function (e) {
      ...
      formHandler("../../assets/server.php", data).then(function (data) {
...
var inputForNum = function inputForNum(elem) {
...
/* harmony default export */ __webpack_exports__["default"] = (inputForNum);
...
var modals = function modals() {
  var modalHandler = function modalHandler(modalSelector, closeSelector, targetSelector) {
  ...
  modalHandler(".popup_calc_end", ".popup_calc_end_close", ".popup_calc_profile_button", false); // setTimeout(() => {
  //     showModal(".popup")
  // }, 6000)
};
...
var tabs = function tabs(tabsWrapperSelector, tabsSelector, contentSelector, activeClass) {
...
var timer = function timer(id, deadline) {
  ...
  var getTimeRemainder = function getTimeRemainder(endtime) {
    var totalTime = new Date(endtime) - new Date(),
  ...
  var timerHandler = function timerHandler(selector, endtime) {
    ...
    function updateTime() {
      var t = getTimeRemainder(endtime);
